...
class UnitConverterForTemperature {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("4 for Kilograms to Pounds ");
        System.out.println("5 for Gallons to Liters ");
        System.out.println("6 for Liters to Gallons ");
        ...
        // Switch statement for different conversions types
        switch (options) {
            case 1:
