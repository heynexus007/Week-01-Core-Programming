...
public class StudentGradeComputation {
    ...
    public static double[][] calcTotalsAndPercentages(int[][] m) {
        double[][] results = new double[m.length][3];
    ...
    public static String[] calcGrades(double[][] percentages) {
    ...
    public static void getScorecard(int[][] scores, double[][] results, String[] grades) {
    ...
    public static void main(String[] args) {
        ...
        double[][] finalRes = calcTotalsAndPercentages(scores);

        //  Calculate grades
        String[] G = calcGrades(finalRes);

        //  Display the scorecard
        System.out.println("Student Scorecard :");
        getScorecard(scores, finalRes, G);
    }
}