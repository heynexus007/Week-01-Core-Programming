...
class DeckOfCardzz {
    ...
    public static void shufflingDeck(String[] deck) {
        int n = deck.length;
    ...
    public static String[][] distributingCards(String[] deck, int numCards, int numPlayers) {
    ...
    public static void printPlayersCardz(String[][] players) {
    ...
    public static void main(String[] args) {
        ...
        try {
            String[][] p = distributingCards(deck, numCards, numPlayers);
