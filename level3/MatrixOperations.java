...
// Creating a class for matrix operations 
class MatrixOperations {
	// Method for creating Random Matrix
    public static int[][] creatingRandomMatrix(int rows, int cols) {
	...
	// Method for determinant2x2
    public static int determinant2x2(int[][] matrix) {
        return matrix[0][0] * matrix[1][1] - matrix[0][1] * matrix[1][0];
    }
	// Method for determinant3x3
    ...
    public static void main(String[] args) {
        int[][] matrix1 = creatingRandomMatrix(3, 3);
        int[][] matrix2 = creatingRandomMatrix(3, 3);
