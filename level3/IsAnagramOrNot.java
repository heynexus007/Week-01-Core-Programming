...
class IsAnagramOrNot {
    ...
    public static void main(String[] args) {
        ...
        String s1 = input.nextLine().replaceAll("[^a-zA-Z0-9]", "").toLowerCase();

        System.out.println("Enter the second text:");
        String s2 = input.nextLine().replaceAll("[^a-zA-Z0-9]", "").toLowerCase();

        // Check if the texts are anagrams
        boolean finalRes = isAnagrams(s1, s2);
